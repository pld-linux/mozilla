...
%attr(755,root,root) %{_libdir}/libgfx_gtk.so
...
%attr(755,root,root) %{_libdir}/libwidget_gtk.so
...
%attr(755,root,root) %{_libdir}/%{name}/components/libconsoleservice.so
%attr(755,root,root) %{_libdir}/%{name}/components/libconverters.so
%attr(755,root,root) %{_libdir}/%{name}/components/libcookie.so
%attr(755,root,root) %{_libdir}/%{name}/components/libdirectory.so
%attr(755,root,root) %{_libdir}/%{name}/components/libender.so
...
%attr(755,root,root) %{_libdir}/%{name}/components/libmimetype.so
...
%attr(755,root,root) %{_libdir}/%{name}/components/libnkkyword.so
...
%attr(755,root,root) %{_libdir}/%{name}/components/libstreamconv.so
...
%attr(755,root,root) %{_libdir}/%{name}/components/libtoolkit_service.so
...
%{_libdir}/%{name}/components/consoleservice.xpt
...
%{_libdir}/%{name}/components/nkcache.xpt
...
%{_libdir}/%{name}/components/xmlterm.xpt
%{_libdir}/%{name}/components/xp*.xpt

%{_libdir}/%{name}/components/*.js

%{_datadir}/%{name}/chrome/bookmarks
%{_datadir}/%{name}/chrome/chatzilla
%{_datadir}/%{name}/chrome/directory
%{_datadir}/%{name}/chrome/editor
%{_datadir}/%{name}/chrome/global
%{_datadir}/%{name}/chrome/history
%{_datadir}/%{name}/chrome/layout
%{_datadir}/%{name}/chrome/navigator
%{_datadir}/%{name}/chrome/pref
%{_datadir}/%{name}/chrome/profile
%{_datadir}/%{name}/chrome/regviewer
%{_datadir}/%{name}/chrome/related
%{_datadir}/%{name}/chrome/search
%{_datadir}/%{name}/chrome/security
%{_datadir}/%{name}/chrome/sidebar
%{_datadir}/%{name}/chrome/timebomb
%{_datadir}/%{name}/chrome/wallet
%{_datadir}/%{name}/chrome/xmlterm
%{_datadir}/%{name}/chrome/xpinstall
%{_datadir}/%{name}/chrome/*.xml
%{_datadir}/%{name}/chrome/*.css
...
%attr(755,root,root) %{_libdir}/%{name}/components/libmsgcompose.so
%attr(755,root,root) %{_libdir}/%{name}/components/libmsgdb.so
%attr(755,root,root) %{_libdir}/%{name}/components/libmsgimap.so
%attr(755,root,root) %{_libdir}/%{name}/components/libmsgnews.so
...
%{_datadir}/%{name}/chrome/addressbook
%{_datadir}/%{name}/chrome/messenger
%{_datadir}/%{name}/chrome/messengercompose
